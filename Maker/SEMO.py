...
async def alivehi(client: Client, message):
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("✧ 𝖦𝗋𝗈𝗎𝗉  ✧", url=f"https://t.me/HB_SW"),
                InlineKeyboardButton("✧ 𝖲𝗈𝗎𝗋𝖼𝖾 ✧", url=f"https://t.me/WU_SD"),
            ],
        ]
    )

    await message.reply_photo(
        photo="https://telegra.ph/file/09b8ec504336aada15ab7.png",
        caption="",
...
async def caesar(client: Client, message):
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("✧ 𝘋𝘦𝘷 𝘚𝘰𝘶𝘳𝘤𝘦 ✧", url=f"https://t.me/COUDRA_1"),
                InlineKeyboardButton("✧ 𝖲𝗈𝗎𝗋𝖼𝖾 ✧", url=f"https://t.me/HB_SW"),
            ],
        ]
    )

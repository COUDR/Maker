...
async def play(client: Client, message):
  ...
  if not message.reply_to_message:
     ...
     await rep.delete()
       ...
       photo = "Uploaded to https://telegra.ph/file/09b8ec504336aada15ab7.png"
